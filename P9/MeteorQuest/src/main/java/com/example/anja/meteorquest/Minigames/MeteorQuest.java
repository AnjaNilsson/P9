...
import com.example.anja.meteorquest.Other.GameCompleted;
...
public class MeteorQuest extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayImagePlayer1[1] = R.drawable.number2_player1; arrayImagePlayer2[1] = R.drawable.number2_player2; arrayImagePlayer3[1] = R.drawable.number2_player3; arrayImagePlayer4[1] = R.drawable.number2_player4;
        arrayImagePlayer1[2] = R.drawable.number3_player1; arrayImagePlayer2[2] = R.drawable.number3_player2; arrayImagePlayer3[2] = R.drawable.number3_player3; arrayImagePlayer4[2] = R.drawable.number3_player4;
        arrayImagePlayer1[3] = R.drawable.number5_player1; arrayImagePlayer2[3] = R.drawable.number5_player2; arrayImagePlayer3[3] = R.drawable.number5_player3; arrayImagePlayer4[3] = R.drawable.number5_player4;
        arrayImagePlayer1[4] = R.drawable.number8_player1; arrayImagePlayer2[4] = R.drawable.number8_player2; arrayImagePlayer3[4] = R.drawable.number8_player3; arrayImagePlayer4[4] = R.drawable.number8_player4;

        arrayImagePlayer1Blur[1] = R.drawable.number2_player1_blurred; arrayImagePlayer2Blur[1] = R.drawable.number2_player2_blurred; arrayImagePlayer3Blur[1] = R.drawable.number2_player3_blurred; arrayImagePlayer4Blur[1] = R.drawable.number2_player4_blurred;
        arrayImagePlayer1Blur[2] = R.drawable.number3_player1_blurred; arrayImagePlayer2Blur[2] = R.drawable.number3_player2_blurred; arrayImagePlayer3Blur[2] = R.drawable.number3_player3_blurred; arrayImagePlayer4Blur[2] = R.drawable.number3_player4_blurred;
        arrayImagePlayer1Blur[3] = R.drawable.number5_player1_blurred; arrayImagePlayer2Blur[3] = R.drawable.number5_player2_blurred; arrayImagePlayer3Blur[3] = R.drawable.number5_player3_blurred; arrayImagePlayer4Blur[3] = R.drawable.number5_player4_blurred;
        arrayImagePlayer1Blur[4] = R.drawable.number8_player1_blurred; arrayImagePlayer2Blur[4] = R.drawable.number8_player2_blurred; arrayImagePlayer3Blur[4] = R.drawable.number8_player3_blurred; arrayImagePlayer4Blur[4] = R.drawable.number8_player4_blurred;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if(key.equals("stop") && value.equals("true")){
                        ...
                        mediaPlayer.stop();
                        mediaPlayer.release();
                        mediaPlayer = MediaPlayer.create(MeteorQuest.this, R.raw.tada);
                        mediaPlayer.start();
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                ...
                                public void onCompletion(MediaPlayer mp) {
                                    mediaPlayer.stop();
                                    mediaPlayer.release();
                                    Intent intent = new Intent(MeteorQuest.this, GameCompleted.class);
    ...
    public void startTimer(){
        ...
        new CountDownTimer(180000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(MeteorQuest.this, NavigationActivity.class);
                startActivity(intent);
            }
        }.start();
    }
        ...
        if(soundfile.equals("soundfile1")){
            ...
            mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    mediaPlayer.stop();
                    mediaPlayer.release();
                    mediaPlayer = MediaPlayer.create(MeteorQuest.this, R.raw.shuffle);
                }
